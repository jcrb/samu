...
Les données des SAMU sont tockées dans un fichier *.csv* de 2006 à 2014 inclus (1 fichier par année). La première ligne est le header. L'ensembles des données sont extraites pour former un fichier *.Rda*.
